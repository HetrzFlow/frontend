...
export const getOverrides = ({
  ...
  const { bgColor, gridColor, scaleTextColor, smBgColor } = themeObj;
...
export const setCSSCustomProperties = ({
  ...
  const _bgColor = isMobile ? smBgColor : bgColor;

  (
    [
      ['--tv-color-platform-background', _bgColor],
      ['--tv-color-pane-background', _bgColor],
      ...
      ['--tv-toolbar-explicit-hover-border-radius', 12],
      ['--tv-color-popup-element-background-hover', btnHoverBg],

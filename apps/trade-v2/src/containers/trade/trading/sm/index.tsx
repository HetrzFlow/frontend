...
const TradeSm = () => {
  ...
  return (
    ...
    >
      <div className="pointer-events-none fixed -bottom-[20px] z-1 h-[148px] w-screen bg-gradient-to-b from-transparent to-black md:hidden"></div>

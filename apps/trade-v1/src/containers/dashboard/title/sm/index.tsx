...
export const DashboardTitleSm: React.FC = () => {
  const { t } = useLingui();
  ...
  return (
    <>
      <h3 className="mb-3 text-2xl/tight font-semibold">{t`Dashboard`}</h3>
      ...
      <div id="date-range-pick" className="my-4">
...
export default DashboardTitleSm;

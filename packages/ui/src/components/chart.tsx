...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        'bg-popover text-popover-foreground z-50 grid min-w-[8rem] items-start gap-0.5 rounded-lg p-2 text-xs shadow-[0px_10px_40px_0_rgba(0,0,0,0.1)] outline-hidden',
        className,
      )}
    >

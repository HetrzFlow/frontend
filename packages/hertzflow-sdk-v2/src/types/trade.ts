...
export type WithdrawalAmounts = {
  ...
  marketTokenUsd: bigint;
  longTokenAmount: bigint;
  /** Long token amount before any swap (used for swap path calculation) */
  longTokenBeforeSwapAmount: bigint;
  shortTokenAmount: bigint;
  /** Short token amount before any swap (used for swap path calculation) */
  ...
  uiFeeUsd: bigint;
  swapPriceImpactDeltaUsd: bigint;
  /** Swap path stats when converting long token to receive token */
  longTokenSwapPathStats?: SwapPathStats;
  /** Swap path stats when converting short token to receive token */
...
export type TradeFeesType = "increase" | "decrease" | "edit";

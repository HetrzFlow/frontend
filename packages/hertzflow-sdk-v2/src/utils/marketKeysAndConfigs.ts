import {
  ...
  MIN_ZFP_COLLATERAL_FACTOR_KEY,
  MAX_ZFP_COLLATERAL_FACTOR_KEY,
  MAX_PROFIT_FACTOR_KEY,
  LOSS_REBATE_FACTOR_KEY,
  ...
  MIN_ZFP_COLLATERAL_FACTOR_FOR_LIQUIDATION_KEY,
  ...
  return {
    ...hashDataMap({
      ...
      depositFeeFactorForBalanceWasImproved: [
        ["bytes32", "address", "bool"],
        [DEPOSIT_FEE_FACTOR_KEY, marketAddress, true],
      ],
      depositFeeFactorForBalanceWasNotImproved: [
        ["bytes32", "address", "bool"],
        [DEPOSIT_FEE_FACTOR_KEY, marketAddress, false],
      ],
      ...
      isZFPEnabled: [
        ["bytes32", "address"],
        [IS_MARKET_ZFP_ENABLED_KEY, marketAddress],
      ],
      minZFPCollateralFactor: [
        ["bytes32", "address"],
        [MIN_ZFP_COLLATERAL_FACTOR_KEY, marketAddress],
      ],
      maxZFPCollateralFactor: [
        ["bytes32", "address"],
        [MAX_ZFP_COLLATERAL_FACTOR_KEY, marketAddress],
      ],
      minZFPCollateralFactorForLiquidation: [
        ["bytes32", "address"],
        [MIN_ZFP_COLLATERAL_FACTOR_FOR_LIQUIDATION_KEY, marketAddress],
      ],
      maxProfitFactor: [
        ["bytes32", "address"],
        [MAX_PROFIT_FACTOR_KEY, marketAddress],
      ],
      lossRebateRate: [
        ["bytes32", "address"],
        [LOSS_REBATE_FACTOR_KEY, marketAddress],
      ],
    }),
    swapFeeReceiverFactor: SWAP_FEE_RECEIVER_FACTOR_KEY,
  };
}

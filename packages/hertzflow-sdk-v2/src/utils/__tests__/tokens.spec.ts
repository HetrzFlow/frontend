...
describe("getIsEquivalentTokens", () => {
  it("checks address, wrappedAddress, synthetic, and symbol", () => {
    expect(getIsEquivalentTokens(getToken("BNB"), getToken("WBNB"))).toBe(true);
    expect(getIsEquivalentTokens(getToken("BNB"), getToken("BNB"))).toBe(true);
    expect(
      getIsEquivalentTokens(
    ...
    expect(getIsEquivalentTokens(getToken("BNB"), getToken("BTC"))).toBe(false);
  });
});

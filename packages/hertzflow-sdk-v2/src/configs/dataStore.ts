...
export const DEPOSIT_FEE_FACTOR_KEY = hashString("DEPOSIT_FEE_FACTOR");
...
export const SWAP_FEE_RECEIVER_FACTOR_KEY = hashString("SWAP_FEE_RECEIVER_FACTOR");
...
export const ACCOUNT_DEPOSIT_LIST_KEY = hashString("ACCOUNT_DEPOSIT_LIST");
export const ACCOUNT_WITHDRAWAL_LIST_KEY = hashString("ACCOUNT_WITHDRAWAL_LIST");
export const ACCOUNT_HLV_DEPOSIT_LIST_KEY = hashString("ACCOUNT_HLV_DEPOSIT_LIST");
export const ACCOUNT_HLV_WITHDRAWAL_LIST_KEY = hashString("ACCOUNT_HLV_WITHDRAWAL_LIST");
...
export const max_cap = hashString("max_cap");
export const MIN_COLLATERAL_FACTOR_FOR_LIQUIDATION_KEY = hashString("MIN_COLLATERAL_FACTOR_FOR_LIQUIDATION");
export const HLV_MAX_MARKET_TOKEN_BALANCE_USD = hashString("HLV_MAX_MARKET_TOKEN_BALANCE_USD");
export const HLV_MAX_MARKET_TOKEN_BALANCE_AMOUNT = hashString("HLV_MAX_MARKET_TOKEN_BALANCE_AMOUNT");
export const IS_HLV_MARKET_DISABLED = hashString("IS_HLV_MARKET_DISABLED");
export const MIN_MARKET_TOKENS_FOR_FIRST_DEPOSIT = hashString("MIN_MARKET_TOKENS_FOR_FIRST_DEPOSIT");
export const MIN_HLV_TOKENS_FOR_FIRST_DEPOSIT = hashString("MIN_HLV_TOKENS_FOR_FIRST_DEPOSIT");
export const HLV_SHIFT_LAST_EXECUTED_AT = hashString("HLV_SHIFT_LAST_EXECUTED_AT");
export const HLV_SHIFT_MIN_INTERVAL = hashString("HLV_SHIFT_MIN_INTERVAL");
export const HLV_DEPOSIT_GAS_LIMIT = hashString("HLV_DEPOSIT_GAS_LIMIT");
export const HLV_WITHDRAWAL_GAS_LIMIT = hashString("HLV_WITHDRAWAL_GAS_LIMIT");
export const HLV_PER_MARKET_GAS_LIMIT = hashString("HLV_PER_MARKET_GAS_LIMIT");
export const MAX_AUTO_CANCEL_ORDERS_KEY = hashString("MAX_AUTO_CANCEL_ORDERS");
export const IS_MARKET_ZFP_ENABLED_KEY = hashString("IS_MARKET_ZFP_ENABLED");
export const MIN_ZFP_POSITION_SIZE_USD_KEY = hashString("MIN_ZFP_POSITION_SIZE_USD");
export const MIN_ZFP_COLLATERAL_FACTOR_KEY = hashString("MIN_ZFP_COLLATERAL_FACTOR");
export const MAX_ZFP_COLLATERAL_FACTOR_KEY = hashString("MAX_ZFP_COLLATERAL_FACTOR");
export const MIN_ZFP_COLLATERAL_FACTOR_FOR_LIQUIDATION_KEY = hashString("MIN_ZFP_COLLATERAL_FACTOR_FOR_LIQUIDATION");
export const MAX_PROFIT_FACTOR_KEY = hashString("MAX_PROFIT_FACTOR");
export const LOSS_REBATE_FACTOR_KEY = hashString("LOSS_REBATE_FACTOR");
...
export const HZ_SIMULATION_ORIGIN = "0x" + keccakString("HZ SIMULATION ORIGIN").slice(-40);
...
export function hlvShiftLastExecutedAtKey(hlvAddress: string) {
  return hashData(["bytes32", "address"], [HLV_SHIFT_LAST_EXECUTED_AT, hlvAddress]);
}

export function hlvShiftMinIntervalKey(hlvAddress: string) {
  return hashData(["bytes32", "address"], [HLV_SHIFT_MIN_INTERVAL, hlvAddress]);
}

export function hlvMaxMarketTokenBalanceUsdKey(hlvAddress: string, market: string) {
  return hashData(["bytes32", "address", "address"], [HLV_MAX_MARKET_TOKEN_BALANCE_USD, hlvAddress, market]);
}

export function hlvMaxMarketTokenBalanceAmountKey(hlvAddress: string, market: string) {
  return hashData(["bytes32", "address", "address"], [HLV_MAX_MARKET_TOKEN_BALANCE_AMOUNT, hlvAddress, market]);
}

export function isHlvDisabledKey(hlvAddress: string, market: string) {
  return hashData(["bytes32", "address", "address"], [IS_HLV_MARKET_DISABLED, hlvAddress, market]);
}

export function minHlvTokensForFirstDepositKey(hlvAddress: string): `0x${string}` {
  return hashData(["bytes32", "address"], [MIN_HLV_TOKENS_FOR_FIRST_DEPOSIT, hlvAddress]) as `0x${string}`;
}

export function minMarketTokensForFirstDepositKey(marketAddress: string): `0x${string}` {
  return hashData(["bytes32", "address"], [MIN_MARKET_TOKENS_FOR_FIRST_DEPOSIT, marketAddress]) as `0x${string}`;
}
...
export function depositFeeFactorKey(market: string, forPositiveImpact: boolean) {
  return hashData(["bytes32", "address", "bool"], [DEPOSIT_FEE_FACTOR_KEY, market, forPositiveImpact]);
}

export function withdrawalFeeFactorKey(market: string, forPositiveImpact: boolean) {
  return hashData(["bytes32", "address", "bool"], [WITHDRAWAL_FEE_FACTOR_KEY, market, forPositiveImpact]);
}
...
export function accountDepositListKey(account: string) {
  return hashData(["bytes32", "address"], [ACCOUNT_DEPOSIT_LIST_KEY, account]);
}

export function accountWithdrawalListKey(account: string) {
  return hashData(["bytes32", "address"], [ACCOUNT_WITHDRAWAL_LIST_KEY, account]);
}

export function accountHlvDepositListKey(account: string) {
  return hashData(["bytes32", "address"], [ACCOUNT_HLV_DEPOSIT_LIST_KEY, account]);
}

export function accountHlvWithdrawalListKey(account: string) {
  return hashData(["bytes32", "address"], [ACCOUNT_HLV_WITHDRAWAL_LIST_KEY, account]);
}
...
export function hashedZfpPositionKey(account: string, market: string, collateralToken: string, isLong: boolean) {
  return hashData(["address", "address", "address", "bool", "string"], [account, market, collateralToken, isLong, "ZFP"]);
}
...
export function minZfpCollateralFactorKey(market: string) {
  return hashData(["bytes32", "address"], [MIN_ZFP_COLLATERAL_FACTOR_KEY, market]);
}

export function maxZfpCollateralFactorKey(market: string) {
  return hashData(["bytes32", "address"], [MAX_ZFP_COLLATERAL_FACTOR_KEY, market]);
}

export function maxProfitFactorKey(market: string) {
  return hashData(["bytes32", "address"], [MAX_PROFIT_FACTOR_KEY, market]);
}

export const lossRebateFactorKey = (market: string) =>
  hashData(["bytes32", "address"], [LOSS_REBATE_FACTOR_KEY, market]);
